...
func (a *App) routes() http.Handler {
	...
	m.HandleFunc("GET /api/whatsapp-waba", a.whatsappWABAConfigs)
	m.HandleFunc("POST /api/whatsapp-waba", a.createWhatsAppWABAConfig)
	m.HandleFunc("PUT /api/whatsapp-waba/{id}", a.updateWhatsAppWABAConfig)
